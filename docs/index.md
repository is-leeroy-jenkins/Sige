![](./img/sige-project.png)

___


Sige is a specialized machine learning and time series forecasting tool built for federal analysts,
budget officers, and data scientists working with Treasury Account Symbols (TAS)  and federal
outlays. It combines classical regression, decision trees, gradient boosting, support vector
...
- This application is delivered as a Streamlit web app (`app.py`) that allows users to upload
  historical federal outlay data (Excel format), explore trends, and generate multi-model forecasts.
...
After a few seconds, Streamlit will open the app automatically in your default web browser (
...
1. Upload an Excel file containing historical outlays with fiscal year columns (e.g., `FY2012`,
   `FY2013`, …).
