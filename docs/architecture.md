# Schedule-X Architecture

## 🧭 Purpose

This page describes the runtime structure of the Schedule-X Streamlit application. The application is organized as a single-page analytical workflow with source-level utility functions supporting data loading, statistical analysis, visualization, machine learning projections, clustering, anomaly detection, and export.
...
Schedule-X prefers Plotly when available. If Plotly is unavailable, the application falls back to Matplotlib and Seaborn where applicable. This preserves interactive charts on fully installed systems while keeping the application usable in lighter Python environments.
